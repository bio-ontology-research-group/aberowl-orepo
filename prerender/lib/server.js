...
var JS_CHECK_TIMEOUT = process.env.JS_CHECK_TIMEOUT || 3000;

var JS_TIMEOUT = process.env.JS_TIMEOUT || 30 * 1000;

var NO_JS_EXECUTION_TIMEOUT = process.env.NO_JS_EXECUTION_TIMEOUT || 3000;

var EVALUATE_JAVASCRIPT_CHECK_TIMEOUT = process.env.EVALUATE_JAVASCRIPT_CHECK_TIMEOUT || 3000;
...
server.onRequest = function(req, res) {
    ...
    tempUrl = tempUrl.replace("http://jagannath.pdn.cam.ac.uk:3007/","http://aber-owl.net/") ;
    req.prerender = {
        url: tempUrl,
        start: new Date()
    };
